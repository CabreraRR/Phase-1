...
- [x] Can install packages via homebrew, in the terminal
```bash
brew install mysql
```
- [x] Can install desktop applications via brew cask, in the terminal
```bash
brew cask install google chrome
```
- [x] Can install a code linter in your editor
```bash
npm install brackets-npm-registry
npm install eslint
```
